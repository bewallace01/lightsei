...
**Terminology (clarified by founder 2026-06-08):** Keep **"constellation"** as the customer-facing word for **a team of AI assistants** — it's the brand metaphor (a constellation = a team; the assistants are its stars), and the founder wants it. So: a workspace's team IS a "constellation." Reframe only the *individual unit*: "agent" / "bot" -> **"assistant"** in customer-facing copy ("agent" stays fine in code + internal docs). Net: "Your constellation — your team of AI assistants." (This corrects the earlier note that implied constellation was internal-only.)
