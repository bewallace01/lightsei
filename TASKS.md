...
>
> **✅ AI Business Team roster COMPLETE — all 6 personas shipped** (website, lead, reputation, marketing, bi, inbox; 60+ tests). The dev bots (argus/vega/sirius/cassiopeia) stay internal/demo per the vision. Remaining toward the full product: per-persona feeders (Gmail poll for inbox, review-source poll for reputation, a weekly-digest job for bi), the "AI Business Team" dashboard reframe, and deploying the roster to the worker.
