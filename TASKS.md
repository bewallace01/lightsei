...
> **(This branch carries two standalone SEO-publish changes split off the Phase 37/38 thread so they can merge independently of the autopublish PR #140, which owns the fuller Phase 37 reconciliation + 37.10.)**
>
